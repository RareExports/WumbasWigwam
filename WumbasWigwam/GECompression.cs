...
// Type: WumbasWigwam.GECompression
...
namespace WumbasWigwam
{
  public class GECompression
  {
    ...
    public GECompression()
    {
      ...
      this.game = GECompression.BANJOTOOIE;
    ...
    public bool CompressGZipFile(string inputFile, string outputFile, bool byteFlipCompressed)
    {
      ...
      {
        uint num2 = num1;
        if (this.game != GECompression.BANJOTOOIE && num2 % 16U != 0U)
          num2 = (uint) ((int) num2 - (int) (num2 % 16U) + 16);
      ...
      if (this.IsFileExist(str3))
      {
        ...
        using (BinaryWriter binaryWriter = new BinaryWriter((Stream) File.Open(outputFile, FileMode.Create)))
        {
          ...
          {
            num3 -= 2U;
            buffer2[(int) num3] = (byte) 17;
            buffer2[(int) num3 + 1] = (byte) 114;
          }
          else if (this.game == GECompression.PD)
          {
            num3 -= 5U;
            buffer2[(int) num3] = (byte) 17;
            buffer2[(int) num3 + 1] = (byte) 115;
            buffer2[(int) num3 + 2] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 3] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 4] = (byte) (num1 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.BANJOKAZOOIE)
          {
            num3 -= 6U;
            buffer2[(int) num3] = (byte) 17;
            buffer2[(int) num3 + 1] = (byte) 114;
            buffer2[(int) num3 + 2] = (byte) (num1 >> 24 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 3] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 4] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 5] = (byte) (num1 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.DONKEYKONG64 || this.game == GECompression.BLASTCORPS)
          {
            num3 -= 10U;
            buffer2[(int) num3] = (byte) 31;
            buffer2[(int) num3 + 1] = (byte) 139;
            buffer2[(int) num3 + 2] = (byte) 8;
            buffer2[(int) num3 + 3] = (byte) 0;
            buffer2[(int) num3 + 4] = (byte) 0;
            buffer2[(int) num3 + 5] = (byte) 0;
            buffer2[(int) num3 + 6] = (byte) 0;
            buffer2[(int) num3 + 7] = (byte) 0;
            buffer2[(int) num3 + 8] = (byte) 2;
            buffer2[(int) num3 + 9] = (byte) 3;
          }
          else if (this.game == GECompression.DONKEYKONG64KIOSK)
          {
            ...
            buffer2[(int) num3 + 1] = (byte) 139;
            buffer2[(int) num3 + 2] = (byte) 8;
            buffer2[(int) num3 + 3] = (byte) 8;
            buffer2[(int) num3 + 4] = (byte) 3;
            buffer2[(int) num3 + 5] = (byte) 69;
            buffer2[(int) num3 + 6] = (byte) 117;
            buffer2[(int) num3 + 7] = (byte) 55;
            buffer2[(int) num3 + 8] = (byte) 0;
            buffer2[(int) num3 + 9] = (byte) 3;
            buffer2[(int) num3 + 10] = (byte) 116;
            buffer2[(int) num3 + 11] = (byte) 109;
            buffer2[(int) num3 + 12] = (byte) 112;
            buffer2[(int) num3 + 13] = (byte) 46;
            buffer2[(int) num3 + 14] = (byte) 98;
            buffer2[(int) num3 + 15] = (byte) 105;
            buffer2[(int) num3 + 16] = (byte) 110;
            buffer2[(int) num3 + 17] = (byte) 0;
          }
          else if (this.game == GECompression.BANJOTOOIE)
          {
            num3 -= 2U;
            ushort num4 = (ushort) Math.Ceiling((double) num1 / 16.0);
            buffer2[(int) num3] = (byte) ((int) num4 >> 8 & (int) byte.MaxValue);
            buffer2[(int) num3 + 1] = (byte) ((uint) num4 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.CONKER)
          {
            num3 -= 4U;
            buffer2[(int) num3] = (byte) (num1 >> 24 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 1] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 2] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 3] = (byte) (num1 & (uint) byte.MaxValue);
          }
          else if (this.game == GECompression.TOPGEARRALLY)
          {
            num3 -= 14U;
            buffer2[(int) num3] = (byte) ((ulong) ((long) int32 - (long) (num3 + 8U) >> 24) & (ulong) byte.MaxValue);
            buffer2[(int) num3 + 1] = (byte) ((ulong) ((long) int32 - (long) (num3 + 8U) >> 16) & (ulong) byte.MaxValue);
            buffer2[(int) num3 + 2] = (byte) ((ulong) ((long) int32 - (long) (num3 + 8U) >> 8) & (ulong) byte.MaxValue);
            buffer2[(int) num3 + 3] = (byte) ((ulong) int32 - (ulong) (num3 + 8U) & (ulong) byte.MaxValue);
            buffer2[(int) num3 + 4] = (byte) (num1 >> 24 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 5] = (byte) (num1 >> 16 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 6] = (byte) (num1 >> 8 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 7] = (byte) (num1 & (uint) byte.MaxValue);
            buffer2[(int) num3 + 8] = (byte) 0;
            buffer2[(int) num3 + 9] = (byte) 0;
            buffer2[(int) num3 + 10] = (byte) 0;
            buffer2[(int) num3 + 11] = (byte) 0;
            buffer2[(int) num3 + 12] = (byte) 0;
            buffer2[(int) num3 + 13] = (byte) 0;
          }
          else if (this.game == GECompression.MILO)
          {
            num3 -= 2U;
            buffer2[(int) num3] = (byte) 120;
            buffer2[(int) num3 + 1] = (byte) 156;
          }
          else if (this.game == GECompression.JFG || this.game == GECompression.JFGKIOSK)
          {
            num3 -= 5U;
            buffer2[(int) num3] = (byte) 4;
            buffer2[(int) num3 + 1] = (byte) 3;
            buffer2[(int) num3 + 2] = (byte) 0;
            buffer2[(int) num3 + 3] = (byte) 0;
            buffer2[(int) num3 + 4] = (byte) 9;
          }
          ...
          if (byteFlipCompressed)
          {
            ...
            {
              byte num5 = buffer2[index];
              buffer2[index] = buffer2[index + 1];
              buffer2[index + 1] = num5;
            }
          }
          binaryWriter.Write(buffer2, (int) num3, (int) ((long) int32 - (long) (num3 + 8U)));
          uint num6 = (uint) ((ulong) int32 - (ulong) (num3 + 8U));
          if (num6 % 8U != 0U)
          {
            for (int index = 0; (long) index < (long) (8U - num6 % 8U); ++index)
            {
      ...
      int num9 = (int) MessageBox.Show("Error Compressing - GZip didn't spit out a file", "Error");
      return false;
    }
    ...
    public byte[] OutputDecompressedBuffer(ref int fileSize, ref int compressedSize)
    {
      ...
      while (this.iterationCounter <= 268435455U)
      {
        ...
        {
          compressedSize = (int) this.bytesIndex;
          return ((IEnumerable<byte>) returnBuffer).Take<byte>(fileSize).ToArray<byte>();
        }
      }
      fileSize = 0;
      return (byte[]) null;
